...
class TestCreateMasterFrame:
    ...
    def test_median_combination(self):
        from pyTransit.calibration import create_master_frame
...
class TestScaleDarkFrame:
    ...
    def test_linear_scaling(self):
        from pyTransit.calibration import scale_dark_frame
...
class TestCreateNormalizedFlat:
    ...
    def test_unit_mean(self):
        from pyTransit.calibration import create_normalized_flat
        bias = flat_image(500.0)
...
class TestCalibrateImage:
    ...
    def test_full_pipeline(self):
        from pyTransit.calibration import calibrate_image
