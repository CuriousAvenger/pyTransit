...
class PipelineConfig:
    ...
    def summary(self):
        ...
        print(f"  t0: {self.transit_model.t0_guess} {'[FIXED]' if self.transit_model.fix_t0 else '[FREE]'}")
        print(f"  Limb darkening: u1={self.transit_model.limb_dark_u1}, u2={self.transit_model.limb_dark_u2}")
